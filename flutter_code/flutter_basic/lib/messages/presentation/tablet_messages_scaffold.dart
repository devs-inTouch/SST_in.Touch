...
class TabletMessagesScaffold extends StatefulWidget {
  final Conversation? conversation; // Define the conversation parameter here

  const TabletMessagesScaffold({super.key, this.conversation});
  @override
  _TabletMessagesScaffold createState() => _TabletMessagesScaffold();
}

class _TabletMessagesScaffold extends State<TabletMessagesScaffold> {
