...
**/
                      ...
                      Stack(
                        children: [
                          ...
                          Positioned(
                            ...
                            child: Container(
                              height: 50,
                              decoration: topBarDecoration, // Apply the topBarDecoration here
                              child: Center(
                                child: textTopBar('Trânsito'), // Use your custom textTopBar widget here
                              ),
                            ),
                          ),
                        ],
                            ...
                            children: [
                              ...
                              Positioned(
                                ...
                                child: Container(
                                  ...
                                  decoration: topBarDecoration, // Apply the topBarDecoration here
                                  child: Center(
                                    child: textTopBar('Tempo no Campus'), // Use your custom textTopBar widget here
                                  ),
                                ),
                              ),
                            ],
  ...
  void addNewActivity(BuildContext context) async {
    ...
    if (pickedDate != null) {
      ...
      int daysRemaining = DateTime.utc(pickedDate.year, pickedDate.month, pickedDate.day)
                ...
                ElevatedButton(
                  onPressed: () {
                    setState(() {
                      ...
                      events.sort((a, b) => a['DiasRestantes'].compareTo(b['DiasRestantes']));
